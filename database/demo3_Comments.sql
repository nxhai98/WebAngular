...
CREATE TABLE `Comments` (
  ...
  CONSTRAINT `Comments_ibfk_2` FOREIGN KEY (`newsId`) REFERENCES `News` (`id`),
...
INSERT INTO `Comments` VALUES (1,7,1,'asdasd','2019-08-08 11:41:10',NULL,NULL),(2,7,1,'asd','2019-08-08 11:41:13',NULL,1);
